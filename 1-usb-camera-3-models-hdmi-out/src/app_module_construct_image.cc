...
std::thread module_construct_image(Buffer& buffer_in_org, Queue& queue_in_face,
    ...
    auto func = [&]() {
        ...
        while (push_on) {
            ...
            // draw live circle
            cv::Scalar color =
                cv::Scalar(255, 255, 255) * (1 - ratio) + cv::Scalar(33, 33, 223) * ratio;
            ...
            auto draw_section = [&display](cv::Mat section_bgr, cv::Mat section_alpha,
                                           int x, int y) {
                cv::Mat section_area_org =
                    display({x, y, section_bgr.cols, section_bgr.rows});
            ...
            draw_section(section_face_bgr, section_face_alpha, 70 + 30,
                         212 + 384 + 30 + 300);
            draw_section(section_od_bgr, section_od_alpha, 70 + 576 + 30 + 30, 212 + 300);
            draw_section(section_pose_bgr, section_pose_alpha, 70 + 576 + 30 + 30,
                         212 + 384 + 30 + 300);
